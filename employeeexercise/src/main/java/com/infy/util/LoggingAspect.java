...
public class LoggingAspect {
	...
	@AfterThrowing("execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))", throwing = "exception")
	public void logAfterThrowingAdviceDetails(JoinPoint joinPoint, Exception exception) {
		logger.info("In After throwing Advice, Joinpoint signature :{}", joinPoint.getSignature());
		logger.error(exception.getMessage(),exception);
	}
	@After("execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))")
	...
	@Before("execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))")
	...
	@AfterReturning(pointcut = "execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))")
	...
	@AfterReturning(pointcut = "execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))", returning = "result")
	...
	@Around("execution(* com.infy.service.EmployeeServiceImpl.fetchEmployee(..))")
